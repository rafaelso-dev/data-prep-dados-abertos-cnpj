...
public final class LocalDate {
    ...
    public static LocalDate fromMillisSinceEpoch(long millisSinceEpoch)
      ...
      if (!(daysSinceEpoch >= Integer.MIN_VALUE && daysSinceEpoch <= Integer.MAX_VALUE)) {
        throw new IllegalArgumentException(String.valueOf("Date should be in the range [-5877641-06-23; 5881580-07-11]"));
        }
