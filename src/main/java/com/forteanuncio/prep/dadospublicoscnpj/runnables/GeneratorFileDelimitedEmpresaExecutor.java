...
public class GeneratorFileDelimitedEmpresaExecutor implements Runnable {
    ...
    public void run() {
        try {
            ...
            StringBuilder insertCommand = new StringBuilder("INSERT INTO dadosabertos.empresa (").append(genericHeader)
                    .append(") values (");
            ...
            insertCommand.append(insertCommandValuesString.substring(0, insertCommandValuesString.length() - 1))
                    .append(")");
